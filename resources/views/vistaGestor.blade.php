<x-layouts.app :title="__('Panel de Gestor')">

    <div class="flex h-full w-full flex-1 flex-col gap-6 rounded-xl">
        <div class="text-center">
            <h1 class="text-3xl font-bold text-gray-900 dark:text-white mb-2">Panel de Gestor</h1>
            <p class="text-gray-600 dark:text-gray-400">Gestión de usuarios y acceso rápido a funciones del sistema</p>
        </div>

        <!-- Sección de Gestión de Usuarios -->
        <div class="grid grid-cols-1 gap-6 md:grid-cols-2 lg:grid-cols-3">
            <div
                class="group relative overflow-hidden rounded-xl border border-neutral-200 bg-white p-6 transition-all duration-200 hover:shadow-lg hover:border-indigo-300 dark:border-neutral-800 dark:bg-neutral-900 dark:hover:border-indigo-600">
                <div class="flex items-center gap-4">
                    ...
                    <div class="flex-1">
                        <h3 class="font-semibold text-gray-900 dark:text-white">Administración de Usuarios</h3>
                        <p class="text-sm text-gray-600 dark:text-gray-400">Gestionar usuarios del sistema</p>
                    </div>
                </div>
                <a href="{{ route('users.index') }}" wire:navigate class="absolute inset-0"></a>
            </div>
        </div>

        <!-- Sección de Registros (igual que vistaAuditor) -->
        <div class="mt-8">
            <h2 class="text-2xl font-bold text-gray-900 dark:text-white mb-4">Registros</h2>
            <div class="grid grid-cols-1 gap-6 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4">
                ...
                <div
                    ...
                    <div class="flex items-center gap-4">
                        ...
                        <div class="flex-1">
                            ...
                            <p class="text-sm text-gray-600 dark:text-gray-400">Realizar inspecciones de calidad en
                                telas</p>
                        </div>
                    </div>
                ...
                <!-- Placeholder 6 -->
                <div
                    class="group relative overflow-hidden rounded-xl border border-neutral-200 bg-white p-6 transition-all duration-200 hover:shadow-lg hover:border-cyan-300 dark:border-neutral-800 dark:bg-neutral-900 dark:hover:border-cyan-600 opacity-60">
                    <div class="flex items-center gap-4">
                        <div
                            class="flex h-12 w-12 items-center justify-center rounded-lg bg-cyan-100 text-cyan-600 dark:bg-cyan-900/50 dark:text-cyan-400">
                            <svg class="h-6 w-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                    d="M12 6v6m0 0v6m0-6h6m-6 0H6"></path>
                            </svg>
